...
async def delete_role(
    ...
    """
    按ID删除角色,角色不存在时报400(dao 层 not-found 抛 ValueError, 由全局处理器映射);成功返回204
    :param role_id: 角色ID
    :param service: 角色服务依赖注入
    """
...
async def update_role(
    ...
    """
    按ID部分更新角色字段(仅传传入的字段),角色不存在时报400;成功返回204
    :param role_id: 角色ID
    :param role: 角色数据
    :param service: 角色服务依赖注入
    """
