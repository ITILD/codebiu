...
from module_ai.dependencies.data_clean import get_data_clean_service
...
@router.post("/clean", summary="LLM 数据清洗", response_model=DataCleanResponse)
async def clean(
...
module_app.include_router(router, prefix="/data-clean", tags=["数据清洗"])
